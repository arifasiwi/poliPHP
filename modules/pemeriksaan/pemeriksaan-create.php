...
<ul class="breadcrumbs">
  ...
  <li class="disabled">Create Data pemeriksaan</li>
</ul>
</nav>
...
if(isset($_POST['submit']))
   {
     ...
     // validation empty
       $db=new Database();
       $db->insert('pemeriksaan',array('nomor'=>$nomor, 'keluhan'=>$keluhan, 'diagnosa'=>$diagnosa, 'perawatan'=>$perawatan, 'tindakan'=>$tindakan, 'berat_badan'=>$berat_badan, 'tensi_diastolik'=>$tensi_diastolik, 'tensi_sistolik'=>$tensi_sistolik, 'pendaftaran_id'=>$pendaftaran_id));
       $res=$db->getResult();
       // redirect to list
